        ...
        <label class="switch">
            ...
            <div class="row mt-5">
                ...
                <div class="col-12 col-lg-12 mt-5">
                    ...
                    <input type="text" class="form-control p-3" placeholder=""  name="smsala_secrect_key" value="{{ $sms_settings->where('name', 'smsala_api_password')->first()->value ?? '' }}"> 
                </div>
                <div class="col-12 col-lg-12 mt-5">
                    <label for="" class="form-label">Sender ID</label> 
                    <input type="text" class="form-control p-3" placeholder=""  name="smsala_token" value="{{ $sms_settings->where('name', 'smsala_sender_id')->first()->value ?? '' }}"> 
                </div>
            </div>
            <div class="text-end mt-5">
                <button type="submit" class="btn btn-primary w-32">Save</button>
